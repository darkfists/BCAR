...
//Functions
   ...
   const typeAction = {
      cat: {
        EarCaress: [
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% closes %POSSESSIVE% eyes and purrs as %OPP_NAME% pets %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% twitches %POSSESSIVE% ears, enjoying the sensation."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% leans into %OPP_NAME%'s touch, savoring the ear scratch."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME%'s ear flicks with delight at %OPP_NAME%'s caresses."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% nuzzles into %OPP_NAME%'s hand, savoring the ear rub."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% lets out a contented sigh as %OPP_NAME% pets %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% leans into %OPP_NAME%'s hand, enjoying the ear scratch."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% makes soft noises of enjoyment as %OPP_NAME% rubs %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% visibly relaxes under %OPP_NAME%'s touch on %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% nuzzles into %OPP_NAME%'s hand, relishing the gentle touch on %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%OPP_NAME%'s soothing touch causes %NAME% to relax and wiggle %POSSESSIVE% ear in contentment."},
          {sound: "Guhh...","Mmngh..","Nnnh~!", action: "%NAME% presses %POSSESSIVE% ear into %OPP_NAME%'s hand, soaking in the affection."},
        ],
        EarNibble: [
      ...
      dog: {
        EarCaress: [
          {sound: "", action: "%NAME%'s eyes close, smiling as %OPP_NAME% rubs %POSSESSIVE% ear gently."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% leans into %OPP_NAME%'s hand, furling %POSSESSIVE% wings as she enjoys the ear scratch."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% sighs contentedly as %OPP_NAME% massages %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% squeaks softly under %OPP_NAME%'s touch."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% squirms and twitches as %OPP_NAME% rubs it."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% lets out a soft whine, enjoying %OPP_NAME%'s ear rub."},
        ],
        EarNibble: [
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s wings unfurl slightly as %OPP_NAME% nibbles %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% lets out a happy sigh as %OPP_NAME% gently nips %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s ear perks up, eager for more of %OPP_NAME%'s nibbling."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s ear twitches as %OPP_NAME% gently nibbles it."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s body squirms as %OPP_NAME% continues to nibble %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% lets out a contented sigh as %OPP_NAME% nibbles %POSSESSIVE% ear."},
        ],
        EarLick: [
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s lips curve up, reveling in the attention."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s ear wiggles, %POSSESSIVE% wings unfurling, as %OPP_NAME% licks."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% lets out a soft squeak, baring her fang as %OPP_NAME% licks %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% closes %POSSESSIVE% eyes and relaxes as %OPP_NAME% licks %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s whole body shivers as %OPP_NAME% licks %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s ear twitches energetically as %OPP_NAME% licks it."},
        ],
        EarKiss: [
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%OPP_NAME%'s kiss on the ear brings a goofy grin to %NAME%'s face."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% lets out a content sigh as %OPP_NAME% kisses %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME%'s ear twitches in delight as %OPP_NAME% gives it a kiss."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% closes %POSSESSIVE% eyes and relaxes as %OPP_NAME% kisses %POSSESSIVE% ear."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% squeaks softly and bares a fang as %OPP_NAME% plants a kiss."},
          {sound: "Guhh...","Mmngh..","Nnnh~", action: "%NAME% gives a contented sigh as %OPP_NAME% kisses %POSSESSIVE% ear."},
        ],
        HeadBrush: [
        ...
        HeadPat: [
          ...
          {sound: "", action: "%NAME% leans into the petting, %POSSESSIVE% body squirming."},
        ...
        CaressBack: [
          {sound: "Mmh..", action: "%NAME%'s butt raises slightly as %OPP_NAME% strokes %POSSESSIVE% back."},
        ],
        MassageBack: [
          {sound: "Mmh..", action: "%NAME%'s butt raises slightly as %OPP_NAME% massages %POSSESSIVE% back."},
        ],
        CaressButt: [
          {sound: "Nnnh~!", action: "%OPP_NAME%'s touch sends shivers down %NAME%'s back, causing %POSSESSIVE% body to quiver."},
          {sound: "Nnnh~!", action: "%NAME%'s wings twitch with pleasure as %OPP_NAME% rubs %POSSESSIVE% butt."},
          {sound: "Mmmngh..", action: "%NAME% is in pure heaven, ears twitching energetically."},
          {sound: "Ah~!", action: "%NAME%'s wings furl as %OPP_NAME% runs some fingers along %POSSESSIVE% butt."},
          {sound: "", action: "wings unfurling, %NAME% revels in the attention on %POSSESSIVE% butt."},
          {sound: "Mmngh..", action: "%NAME%'s squirms happily as %OPP_NAME% pets %POSSESSIVE% butt."},
        ],
      },
      fox: {
        EarCaress: [
