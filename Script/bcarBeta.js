   ...
   const typeAction = {
      ...
      dog: {
        EarCaress: [
          ...
          {sound: "", action: "%NAME% leans into %OPP_NAME%'s hand, furling %POSSESSIVE% wings as she enjoys the ear scratch."},
          {sound: "", action: "%NAME% sighs contentedly as %OPP_NAME% massages %POSSESSIVE% ear."},
          {sound: "", action: "%NAME% squeaks softly under %OPP_NAME%'s touch."},
          {sound: "", action: "%NAME% squirms and twitches as %OPP_NAME% rubs it."},
          {sound: "", action: "%NAME% lets out a soft whine, enjoying %OPP_NAME%'s ear rub."},
        ],
        EarNibble: [
          {sound: "", action: "%NAME%'s wings unfurl slightly as %OPP_NAME% nibbles %POSSESSIVE% ear."},
          {sound: "", action: "%NAME% lets out a happy sigh as %OPP_NAME% gently nips %POSSESSIVE% ear."},
          {sound: "", action: "%NAME%'s ear perks up, eager for more of %OPP_NAME%'s nibbling."},
          {sound: "", action: "%NAME%'s ear twitches as %OPP_NAME% gently nibbles it."},
          {sound: "", action: "%NAME%'s body squirms as %OPP_NAME% continues to nibble %POSSESSIVE% ear."},
          {sound: "", action: "%NAME% lets out a contented sigh as %OPP_NAME% nibbles %POSSESSIVE% ear."},
        ],
        EarLick: [
          {sound: "", action: "%NAME%'s lips curve up, reveling in the attention."},
          {sound: "", action: "%NAME%'s ear wiggles, %POSSESSIVE% wings unfurling, as %OPP_NAME% licks."},
          {sound: "", action: "%NAME% lets out a soft squeak, baring her fang as %OPP_NAME% licks %POSSESSIVE% ear."},
          {sound: "", action: "%NAME% closes %POSSESSIVE% eyes and relaxes as %OPP_NAME% licks %POSSESSIVE% ear."},
          {sound: "", action: "%NAME%'s whole body shivers as %OPP_NAME% licks %POSSESSIVE% ear."},
          {sound: "", action: "%NAME%'s ear twitches energetically as %OPP_NAME% licks it."},
        ],
        EarKiss: [
          {sound: "", action: "%OPP_NAME%'s kiss on the ear brings a goofy grin to %NAME%'s face."},
          ...
          {sound: "", action: "%NAME% squeaks softly and bares a fang as %OPP_NAME% plants a kiss."},
        ...
        CaressBack: [
          {sound: "", action: "%NAME%'s butt raises slightly as %OPP_NAME% strokes %POSSESSIVE% back."},
        ],
        MassageBack: [
          {sound: "", action: "%NAME%'s butt raises slightly as %OPP_NAME% massages %POSSESSIVE% back."},
        ],
        CaressButt: [
          {sound: "", action: "%OPP_NAME%'s touch sends shivers down %NAME%'s back, causing %POSSESSIVE% body to quiver."},
          {sound: "", action: "%NAME%'s wings twitch with pleasure as %OPP_NAME% rubs %POSSESSIVE% butt."},
          {sound: "", action: "%NAME% is in pure heaven, ears twitching energetically."},
          {sound: "", action: "%NAME%'s wings furl as %OPP_NAME% runs some fingers along %POSSESSIVE% butt."},
          {sound: "", action: "wings unfurling, %NAME% revels in the attention on %POSSESSIVE% butt."},
          {sound: "", action: "%NAME%'s squirms happily as %OPP_NAME% pets %POSSESSIVE% butt."},
        ],
      },
      fox: {
        EarCaress: [
